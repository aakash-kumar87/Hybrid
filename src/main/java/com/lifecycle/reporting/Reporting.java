package com.lifecycle.reporting;
...
import com.lifecycle.library.Messages;

//import accelerators.BaseDriverUtil;
...
public class Reporting {
	...
	/*******************************************************************************
	 * Function Name : logResults Description : Logs the result step based on the
	 * given status, desc, result under the assigned functionality and testscript
	 * Parameters : sStatus, sStepdescription, sStepResult Usage :
	 * logResults(sStatus, sStepdescription, sStepResult) Created By : Aakash Created
	 * On :
	 * 
	 * @param driver TODO
	 * 
	 * @throws IOException
	 ******************************************************************************/
	public static void logResults(WebDriver driver, String sStatus, String sStepdescription, String sStepResult)
		...
		// update step node
		addOrUpdateStepNode(sStatus, sStepdescription, sStepResult, driver);
	...
	/*******************************************************************************
	 * Function Name : createResultfolder Description : Creates the 'logs' folder
	 * under the project root node if the logs folder is not there already
	 * Parameters : Usage : createResultfolder() Created By : Aakash Created On :
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Function Name : openXMLFile Description : creates xml file(with unique name)
	 * with basic root node(test suite node) and other info Parameters : Usage :
	 * openXMLFile() Created By : Aakash Created On :
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Function Name : createXMLFile Description : creates xml file(with unique
	 * name) with basic root node(test suite node) and other info Parameters : Usage
	 * : createXMLFile() Created By : Aakash Created On :
	 ******************************************************************************/
...
//			System.setProperty("javax.xml.transform.TransformerFactory","com.sun.org.apache.xalan.internal.xsltc.trax.TransformerFactoryImpl");
			...
			xmlDocument.insertBefore(
					xmlDocument.createProcessingInstruction("xml-stylesheet", "type=\"text/xsl\" href=\"Result.xsl\""),
	...
	/*******************************************************************************
	 * Function Name : now Description : returns the current date and time with
	 * MM-dd-yyyy HH:mm:ss format Parameters : Usage : String sTime = now() Created
	 * By : Aakash Created On :
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Function Name : changeToEditMode Description : changes the xml file to edit
	 * mode Parameters : Usage : changeToEditMode Created By : Aakash Created On :
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Function Name : addOrUpdateFunctionalityNode Description : If the
	 * functionality node is not available, it adds the functionality node.
	 * Parameters : Usage : changeToEditMode Created By : Aakash Created On :
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Function Name : addOrUpdateTestScriptNode Description : If the testscript
	 * node is not available, it adds the testscript node. Parameters : Usage :
	 * addOrUpdateTestScriptNode() Created By : Aakash Created On :
	 ******************************************************************************/
	...
	private static void addOrUpdateStepNode(String sStatus, String sStepdescription, String sStepResult,
			WebDriver driver) throws IOException, AWTException {
	...
	/*******************************************************************************
	 * Function Name : checkFunctionalNodeAvailable Description : Checks whether
	 * the functionality node exist or not Parameters : Usage : bStatus =
	 * checkFunctionalNodeAvailable() Created By : Aakash Created On :
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Function Name : checkTestScriptNodeAvailable Description : Checks whether the
	 * testscript node exists or not Parameters : Usage : bStatus =
	 * checkTestScriptNodeAvailable() Created By : Aakash Created On :
	 ******************************************************************************/
	private static boolean checkTestScriptNodeAvailable() {
		try {
			XPath xPath = XPathFactory.newInstance().newXPath();
			String expression = "//Functionality[@name='" + sXMLCurrentFunctionality + "']/TestScript[@name='"
	...
	/*******************************************************************************
	 * Function Name : checkIteratorNodeAvailable Description : Checks whether the
	 * iterator node exists or not Parameters : Usage : bStatus =
	 * checkIteratorNodeAvailable() Created By : Aakash Created On :
	 ******************************************************************************/
	private static boolean checkIteratorNodeAvailable() {
		try {
			XPath xPath = XPathFactory.newInstance().newXPath();
			String expression = "//Functionality[@name='" + sXMLCurrentFunctionality + "']/TestScript[@name='"
					+ sXMLCurrentScriptName + "']/Iterator[@no='" + sXMLCurrentIterator + "']";
			NodeList nodeList = (NodeList) xPath.compile(expression).evaluate(doc, XPathConstants.NODESET);
			NodeList nodeListElement = (NodeList) xPath.compile(expression).evaluate(doc, XPathConstants.NODE);
			if (nodeList.getLength() > 0) {
	...
	/*******************************************************************************
	 * Function Name : getFailTestCaseCount Description : Determines the total fail
	 * test cases count Parameters : Usage : iFailCount = getFailTestCaseCount()
	 * Created By : Aakash Created On :
	 ******************************************************************************/
	private static int getFailTestCaseCount() {
		...
		try {
			...
			for (int iCount = 1; iCount <= nodeList.getLength(); iCount++) {
				...
				NodeList TCFailnodeList = (NodeList) xPath.compile(sFailExpression).evaluate(doc,
	...
	/*******************************************************************************
	 * Function Name : getPassTestCaseCount Description : Determines the total pass
	 * test cases count Parameters : Usage : iPassCount = getPassTestCaseCount()
	 * Created By : Aakash Created On :
	 ******************************************************************************/
	private static int getPassTestCaseCount() {
		...
		try {
			...
			for (int iCount = 1; iCount <= nodeList.getLength(); iCount++) {
				...
				NodeList TCPassNodeList = (NodeList) xPath.compile(sPassExpression).evaluate(doc,
						XPathConstants.NODESET);
	...
	/*******************************************************************************
	 * Function Name : getTotalTestCaseCount Description : Determines the total test
	 * cases count Parameters : Usage : iTotalTCCount = getTotalTestCaseCount()
	 * Created By : Aakash Created On :
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Function Name : updateFailStatus Description : Updates the rootnode attribute
	 * TC_Status as fail if any test step is failed Parameters : Usage :
	 * iTotalTCCount = updateFailStatus() Created By : Aakash Created On :
	 ******************************************************************************/
	...
	public static boolean CaptureScreenshot(WebDriver driver) throws IOException {
		...
		try {
			...
			// String appImageFileName = desc + "_" + BaseTest.generateRandString("short") +
			// ".png";
	...
	/**
	 * Sets up Reporting values for a test script. This method is called within the
	 * test script's setUp() method before performing the initial login.
	 * 
	 * @param sPackageName test script class/package name
	 */
	public static void setReportingValues(String sPackageName) {
		String[] arrPackage = sPackageName.split("\\.");
		Reporting.Functionality = arrPackage[arrPackage.length - 2].substring(0, 1).toUpperCase()
				+ arrPackage[arrPackage.length - 2].substring(1);
		Reporting.Testcasename = arrPackage[arrPackage.length - 1];
	}
